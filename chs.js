...
var cnItems = {
    ...
    "NXT": "下一个",
    "MXT": "最大下一个",
    "To be informed when your device will be supported and new features will be ready, please join Discord server.": "要了解何时支持您的设备以及准备好新功能，请加入 Discord 服务器。",
    "Your device is not supported for the moment.": "目前不支持您的设备。",
    "": "",
    "": "",
    "": "",
    "": "",
